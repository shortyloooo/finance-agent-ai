...
def get_ai_parsed_fields(user_text: str, today: str):
    prompt = f"""
        ...
        2. If the user provides a specific date, use that date.
        3. Convert natural language dates into YYYY-MM-DD.
        4. Examples:
        - "on 4th May 2026" → "2026-05-04"
        - "4 May 2026" → "2026-05-04"
        - "May 4 2026" → "2026-05-04"
        - "04/05/2026" → "2026-05-04" if the text appears to use day/month/year format
        - "2026-05-04" → "2026-05-04"
        5. If the user says "today", use: {today}.
        6. If the user gives no date, use: {today}.
        7. If the date is unclear, use: {today}.
        8. Never return words like "end", "tomorrow", "yesterday", "next week", or "unknown" inside transaction_date.
        9. Never return invalid dates.
        ...
        - Health: clinic, hospital, doctor, medicine, pharmacy, gym, chiropractor
